...
class Meteo {
    ...
    cargarDatos(c){
        ...
        this.url = "http://api.openweathermap.org/data/2.5/weather?q=" + this.ciudad + this.tipo + this.unidades + this.idioma + "&APPID=" + this.apikey;
            ...
            success: function(datos){
                    ...
                    $("h4").text((new XMLSerializer()).serializeToString(datos));
                    ...
                    var stringDatos = '<img src= "http://openweathermap.org/img/w/'+ foto +'.png" height="64px" width="64px">';
    ...
    verXML(c){
        ...
        //this.crearElemento("h4","Datos en XML desde <a href='http://openweathermap.org'>OpenWeatherMap</a>","footer"); 
        this.cargarDatos(c);
        
        //$("tiempoEdimburgo").attr("disabled","disabled");
    }
}
var meteo = new Meteo();